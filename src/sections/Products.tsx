...
const ALL_PRODUCTS = [
  ...
  // Dairy — nouvelles images officielles
  { id: "lait-400",     name: "Lait en Poudre 400g",     category: "dairy",   src: "/products/Milk Powder - 400gm.png", tag: "Laitier" },
  { id: "lait-900",     name: "Lait en Poudre 900g",     category: "dairy",   src: "/products/Milk Powder - 900gm.png", tag: "Laitier" },
  { id: "lait-1800",    name: "Lait en Poudre 1800g",    category: "dairy",   src: "/products/Milk Powder - 1800gm.png",tag: "Laitier" },
  { id: "lait-2250",    name: "Lait en Poudre 2250g",    category: "dairy",   src: "/products/Milk Powder - 2250gm.png",tag: "Laitier" },
  // Canned
  ...
  { id: "sardine",      name: "Sardine",                 category: "seafood", src: "/products/sardine.png",             tag: "Mer" },
  { id: "sardine-p",    name: "Sardine Premium",         category: "seafood", src: "/products/sardine-premium.png",     tag: "Mer" },
  // Pasta
  ...
  { id: "spaghetti",    name: "Spaghetti",               category: "pasta",   src: "/products/spaghetti.png",           tag: "Pâtes" },
  // Bakery
...
const TAG_COLORS: Record<string, { bg: string; text: string; glow: string }> = {
  ...
  "Pâtes":       { bg: "#C8B612", text: "#fff",    glow: "rgba(200,182,18,0.4)"  },
  "Boulangerie": { bg: "#A52520", text: "#fff",    glow: "rgba(165,37,32,0.4)"   },
  "Gourmandise": { bg: "#83AC30", text: "#fff",    glow: "rgba(131,172,48,0.4)"  },
};
...
export default function Products() {
  ...
  return (
    <section id="produits" ref={sectionRef} className="overflow-hidden py-20 lg:py-28" style={{ background: "#FFF6E1" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sr text-center mb-14">
          ...
          <p className="text-[#4A4A4A]/70 max-w-lg mx-auto">{t("products.subtitle")}</p>
        </div>
        ...
        <div className="sr sr-d1 flex gap-2 flex-wrap justify-center mb-12">
          {tabs.map((tab) => (
            <motion.button
              ...
              style={
                activeTab === tab.key
                  ? { background: "#026D41", color: "#FDEA02", boxShadow: "0 4px 16px rgba(2,109,65,0.30)" }
                  : { background: "rgba(2,109,65,0.07)", color: "#026D41" }
              }
            >
              {tab.label as string}
            </motion.button>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex flex-col overflow-hidden h-full transition-all duration-300"
                    ...
                    onMouseLeave={e => {
                      (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 24px rgba(2,109,65,0.08)";
                      (e.currentTarget as HTMLElement).style.borderColor = "rgba(2,109,65,0.08)";
                    }}
                  >
        ...
        <div className="sr sr-d2 text-center mt-12">
          <motion.a
            ...
            style={{ background: "#026D41", color: "#FDEA02", boxShadow: "0 6px 24px rgba(2,109,65,0.30)" }}
          >
